...
public final class ADefinicaoBllocoFecho extends PBllocoFecho
{
    private PIdOuAttr _idOuAttr_;
    private PExp _exp_;

    public ADefinicaoBllocoFecho()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADefinicaoBllocoFecho(
    ...
    {
        ((Analysis) sw).caseADefinicaoBllocoFecho(this);
    }
